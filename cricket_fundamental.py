            ...
            if res.status_code == 200:
                    ...
                    for li in top_ratios.find_all('li'):
                        ...
                        if name_elem and val_elem:
                            ...
                            if val is not None:
                                ...
                                elif 'int coverage' in name or 'interest coverage' in name: metrics['interest_coverage_ttm'] = val
                                elif 'opm' in name: metrics['opm'] = val
                                elif any(k in name for k in ['pledged', 'pledge', 'encumbered']): metrics['promoter_pledge'] = val
                ...
                if shp:
                    for tr in shp.find_all('tr'):
                        ...
                        if nums:
                            if 'pledged' in row_txt or 'encumbered' in row_txt: metrics['promoter_pledge'] = nums[-1]
                            elif 'promoter' in row_txt and metrics['promoter_holding'] is None: metrics['promoter_holding'] = nums[-1]
