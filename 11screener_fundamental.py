...
# ============================================================
# 🇮🇳 GK FUNDAMENTAL ENGINE — ULTIMATE (WITH AUTO-LOGIN)
# ============================================================

# ಲಾಗಿನ್ ವಿವರಗಳು (Screener Credentials)
...
# --- 2. Bottom Financial Tables Extract (LAST COLUMN) ---
...
def get_fundamental_analysis(symbol):
    ...
    # 2. BULLETPROOF SHAREHOLDING (Top box first, then Bottom Table fallback)
    ...
    # 4. BULLETPROOF INTEREST COVERAGE
